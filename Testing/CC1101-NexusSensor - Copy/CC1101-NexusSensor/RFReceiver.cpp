...
static bool RFReceiver::syncDetected = false;
    static bool RFReceiver::gotPulse = false;
    static int RFReceiver::bitcount = 0;
    static bool RFReceiver::dataAvailable = 0;
    static int RFReceiver::protocolType = 1;
    static long RFReceiver::lt = 0;
    static int RFReceiver::lastBit = 0;

void RFReceiver::setInterrupt(int interrupt) {
  attachInterrupt(interrupt, interuptDetected, CHANGE);
}
